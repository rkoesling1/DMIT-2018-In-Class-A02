...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="row">
        <div class="col-md-12">
            ...
            <asp:RadioButtonList ID="RadioButtonList1" runat="server" DataSourceID="ActiveEventsDataSource" AppendDataBoundItems="true" RepeatLayout="Flow" RepeatDirection="Horizontal" DataTextField="Description" DataValueField="Code">
