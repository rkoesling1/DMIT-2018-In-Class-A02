...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="row">
        <div class="col-md-12">
            ...
            <asp:RadioButtonList ID="ActiveEventRadioButtonList" runat="server" DataSourceID="ActiveEventsDataSource" AppendDataBoundItems="true" RepeatLayout="Flow" RepeatDirection="Horizontal" DataTextField="Description" DataValueField="Code">
            ...
            <asp:Repeater ID="ReservationsReperater" runat="server" DataSourceID="DailyReservationsDataSource" ItemType="eRestaurant.Framework.Entities.DTO.DailyReservation">
                <ItemTemplate>
                    Month: <%# Item.Month %>
                    Day: <%# Item.Day %>
                </ItemTemplate>
