...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <!-- Showing the Reservation for a particular date -->
    <div class="pull-right col-md-5">
        <details open>
            <summary>Reservation by Date/Time</summary>
            <h4>Today's Reservations</h4>
            <asp:Repeater ID="ReservationsRepeater" runat="server" DataSourceID="ReservationDataSource" ItemType="eRestaurant.Framework.Entities.DTO.ReservationCollection">
                <ItemTemplate>
                    <h4><%# Item.Hour %></h4>
                    <asp:ListView ID="ReservationSummaryListView" runat="server" ItemType="eRestaurant.Framework.Entities.DTO.ReservationSummary" DataSource="<%# Item.Reservations %>">
                        <LayoutTemplate>
                            <div class="seating">
    ...
    <div class="col-md-7">
        <h3>Tables</h3>
        <asp:GridView ID="SeatingGridView" runat="server" AutoGenerateColumns="False" DataSourceID="SeatinObjectDataSource">
            <Columns>
        ...
        <asp:ObjectDataSource ID="SeatinObjectDataSource" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="SeatingByDateTime" TypeName="eRestaurant.Framework.BLL.SeatingController">
            <SelectParameters>
                <asp:ControlParameter ControlID="SearchDate" PropertyName="Text" Name="date" Type="DateTime"></asp:ControlParameter>
