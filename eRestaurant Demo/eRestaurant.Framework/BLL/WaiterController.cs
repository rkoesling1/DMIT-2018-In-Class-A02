    ...
    public class WaiterController
    {
        ...
        public void SplitBill(int billid, List<OrderItem> updatesToOriginalBillItems, List<OrderItem> newBillItems)
        {
            ...
            using (var context = new RestaurantContext())
            {
                ...
                // Actually remove the item for the database.....
                ...
                var newBill = new Bill()
                {
                    ...
                    // TODO: thorny question about rules around splitting bil for
                    //       a singel tabel vs reservation
                };

                // 4) Add the new moved item to the new bill
                foreach(var item in toRemove)
                {
                ...
                // 6) Save the changes...
                context.SaveChanges(); // Call this only ONCE at the end
            }
        }
    }
}
