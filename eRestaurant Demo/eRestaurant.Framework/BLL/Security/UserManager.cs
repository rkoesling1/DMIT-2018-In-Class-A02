    ...
    public class UserManager : UserManager<ApplicationUser>
    {
        ...
        public void AddDefaultUsers()
        {
            using (var context = new RestaurantContext())
            {
                ...
                var employee = from data in context.Waiters
                               where !data.ReleaseDate.HasValue // they are still employed
                               select data;
                foreach(var person in employee)
                {
                    // Check if they exist as a user
                    // if (NOT any of the Users exist such that => 
                    // u represents a given user 
                    //      where the user's WaiterID has a value
                    ...
                    if (!Users.Any(u => u.WaiterID.HasValue && u.WaiterID.Value == person.WaiterID))
                    {
                        ...
                        // NOTE: The following line of code needs the use the this keyboard
